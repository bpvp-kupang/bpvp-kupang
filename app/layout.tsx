...
export const metadata: Metadata = {
  ...
  description:
  "Portal resmi BPVP Kupang yang menyediakan informasi program pelatihan vokasi, jadwal pelatihan, berita, galeri, dan layanan informasi bagi masyarakat Nusa Tenggara Timur.",
  keywords: [
    "BPVP Kupang",
